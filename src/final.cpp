...
ros::NodeHandle nh;
  ...
  ros::Publisher left_arm_wrist_roll_joint      = nh.advertise<std_msgs::Float64>("left_gripper_joint_controller/command", 1000);
...
int main(int argc, char **argv)
{
  ...
  ros::Subscriber sub_moveit = nh.subscribe("/move_group/fake_controller_joint_states", 1000, chatterCallback);
